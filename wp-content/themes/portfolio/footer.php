    <footer id="footer">
      <div class="container cf">
        <p class="footerText">Find me on SNS:</p>
        <ul class="icons">
  ...
  <script src="<?php echo get_template_directory_uri(); ?>/js/particle.js" type="text/javascript"></script>
